...
def test_audit_repo_detects_required_and_optional_files(tmp_path: Path):
    ...
    create_file(tmp_path, "tools/agent_cli/tool_spec.json", "{}")
    create_file(tmp_path, "tools/agent_cli/cli.py")
...
def test_audit_repo_json_output_shape(tmp_path: Path):
    ...
    create_file(tmp_path, "tools/agent_cli/tool_spec.json", json.dumps({"id": "agent_cli"}))
    create_file(tmp_path, "tools/agent_cli/cli.py")
